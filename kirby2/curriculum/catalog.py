...
LESSONS = (
    ...
    CurriculumLesson(
        ...
        "AGGRESSIVE_ENTRY",
        ("SPREAD_DECISION", "VOLUME_CONTEXT"),
        "balanced",
        (V.X1_00, V.X2_00),
        (L.NORMAL, L.DEEP),
    ...
    CurriculumLesson(
        ...
        "TAPE_READING",
        ("AGGRESSIVE_ENTRY", "VOLUME_CONTEXT"),
        "momentum_up",
        (V.X1_00, V.X2_00, V.X5_00),
        (L.THIN, L.NORMAL),
