...
def _audit_dev0015() -> ExpansionGateReport:
    from kirby2.audit.release import (
        audit_release_linux_qualification_executor_restart,
    )
...
def _audit_dev0018() -> ExpansionGateReport:
    from kirby2.audit.release import audit_release_performance_verifier_restart
...
def _audit_dev0019() -> ExpansionGateReport:
    from kirby2.audit.release import audit_release_closeout_gate_restart
...
GATE_SPECS: tuple[tuple[str, ExpansionGate], ...] = (
    ...
    ("DEV-0018", _audit_dev0018),
    ("DEV-0019", _audit_dev0019),
    ("WO40-J", _audit_wo40j),
)
